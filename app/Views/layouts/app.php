    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="<?php echo base_url('pekerjaan')?>" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Pekerjaan</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-chart-bar me-2"></i>RAB atau Kontrak</a>
